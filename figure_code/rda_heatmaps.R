...
rda_df$response = recode(rda_df$response, Musicaldist = "All",
                         Differentiationdist = "Articulation",
                         Dynamicsdist = "Dynamics",
                         Ornamentationdist = "Ornamentation",
                         Rhythmdist = "Rhythm",
                         Tensiondist = "Tension")
rda_df$response = factor(rda_df$response, levels = c("All", "Articulation", "Dynamics", "Ornamentation", "Rhythm", "Tension"))
